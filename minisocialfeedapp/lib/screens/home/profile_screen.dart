...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    super.initState();
    // Fetch profile stats when screen initializes
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (authProvider.user != null) {
        profileProvider.fetchUserStats(authProvider.user!.uid);
      }
    });
  }
  ...
  Future<void> _refreshProfile() async {
    ...
    if (authProvider.user != null) {
      await profileProvider.refreshStats(authProvider.user!.uid);
    }
  }
